...
# PRECISAMOS VALIDAR SE PRECISA PASSAR POR UM PROCESSO DE PADRONIZAÇÃO ZSCORE
# A vARIÁVEL APSSA A TER MÉDIA 0 E DESVIO PADRÃO 1 
df_quanti.describe()
...
# NO K-MEANS a clusterizxação ocorre por meio dos centroides mas precisamos definir a quantidade de clusters a prióre
# O método de elbo retorna os resultados de iterativos de clusters 
# buscamso a dobra, ou seja onde as distãncias já não são mais tão significativas
...
#Compara as distâncias médias entre a obs e seu cluster e da obs para os clusters n seus.
#Quanto mais próximo de 1 melhor, mais parecidas as informações 
#Peegar a maior silhueta média 
