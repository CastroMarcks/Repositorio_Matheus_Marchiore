...
# nada mais é que a correl entre o fator e a boservação
...
#demonstra sem ouver perda ou não das infos 
...
#pesos de cada variável para o fator
scores = fa.weights_
...
#procedimento de categorização por parte
#pois para avaliar a correl de group e fator precisamos de 2 quali
# Criando 4 grupos
pisa['categoria'] = pd.qcut(pisa['fator_2022'], 4, labels=list(['grupo_1', 'grupo_2', 'grupo_3', 'grupo_4']))

#%% Há associação com o grupo dos países?
#Agora análise de correspondência 
...
# quando os residuos maiores que 1.96  existe uma correlação entre os grupos, SÓ OLHAMOS OS MAIORES DE 1.96 POIS SÃO OS QUE ESTÃO ACONTECENDO MAIORES OCORRÊNCIAS QUE O NORMAL. 
